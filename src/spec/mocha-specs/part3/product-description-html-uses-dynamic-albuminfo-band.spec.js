...
describe("ProductDescription", () => {
  it("should use artist name data from the giftProductInfo property in the HTML template @product-description-html-uses-dynamic-albuminfo-band", () => {
    ...
    assert(
      albumBandDiv.text().match(/{{\s*giftProductInfo\?\.artist\s*}}/),
      "We'd like you to query the `giftProductInfo` property directly for the artist name, and we're not seeing that you're doing that."
    );
  });
});
