...
describe("ProductDescription", () => {
  it("should use album name data from the giftProductInfo property in the HTML template @product-description-html-uses-dynamic-albuminfo-name", () => {
    ...
    assert(
      albumNameDiv.text().match(/{{\s*giftProductInfo\?\.album\.name\s*}}/),
      "We'd like you to query the `giftProductInfo` property directly for the album name, and we're not seeing that you're doing that."
    );
  });
});
