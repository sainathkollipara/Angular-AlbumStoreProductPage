...
describe('ProductDescription', function() {
  it(`should have an giftProductInfo property typed to GiftProduct @product-description-albuminfo-property-typed-to-album`, function () {
    let file;
    try {
    ...
    let re = /giftProductInfo\s*\:\s*(\w+)/
    let match = file.match(re);
    assert(Array.isArray(file.match(re)), "The `giftProductInfo` property doesn't have any type information declared yet.");
